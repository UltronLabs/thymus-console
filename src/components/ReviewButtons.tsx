...
const ACTIONS: { outcome: ReviewOutcome; label: string; icon: typeof Check; cls: string }[] = [
  { outcome: "released", label: "Release", icon: Check, cls: "border-emerald-500/30 text-emerald-300 hover:bg-emerald-500/10" },
  { outcome: "marked_safe", label: "Mark safe", icon: ShieldCheck, cls: "border-sky-500/30 text-sky-300 hover:bg-sky-500/10" },
  { outcome: "deleted", label: "Delete", icon: Trash2, cls: "border-rose-500/30 text-rose-300 hover:bg-rose-500/10" },
];
